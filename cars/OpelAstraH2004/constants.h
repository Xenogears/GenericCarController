...
#include <avr/pgmspace.h>
	...
	extern const PROGMEM char sDIS[];
	extern const PROGMEM char sBC[];
	extern const PROGMEM char sRAD[];
	extern const PROGMEM char sSIM[];
	extern const PROGMEM char sTST[];
	extern const PROGMEM char sRND[];
	extern const PROGMEM char sLED[];
	extern const PROGMEM char sSettings[];
	extern const PROGMEM char sRD[];
	extern const PROGMEM char sBC_Lower[];
	extern const PROGMEM char sUp[];
	extern const PROGMEM char sDown[];
	extern const PROGMEM char sLeft[];
	extern const PROGMEM char sRight[];
